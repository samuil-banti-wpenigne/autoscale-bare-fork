jQuery(window).on("load", (_) => {
	const loading_icon =
		'<img src="' + frontendajax.nitro_plugin_url + '/view/images/loading.svg" width="14" class="icon loading"/>';
	...
	jQuery(".nitropack-invalidate-cache-entire-site").click(function (e) {
		e.preventDefault();
		clearCacheEntireHandler("invalidate", jQuery(this));
		return false;
	});
});
